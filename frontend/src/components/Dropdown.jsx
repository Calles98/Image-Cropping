    ...
    return (
        <div className='w-full py-6 pb-8 z-50'>
            <div className="relative inline-block">
                ...
                >
                    {currentValue} <svg className="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                        ...
                        <ul role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                           {
                            [20, 40, 50, 60, 70, 80, 90].map((item) => (
                                <li key={item} className="text-gray-700 block px-4 py-2 text-sm hover:bg-gray-100 cursor-pointer" role="menuitem" onClick={() => handleValueChange(item)}>
                                    {item}
                                </li>
                            ))
                           }
